...
This section will walk you through setting up the universal asynchronous receiver-transmitter (UART) serial communication peripheral and show how it can be used to send messages to your computer. You will need to have completed the inital project creation above before you start this section. 
...
11. At the bottom of the window select the "Problems" tab to view the warnings. The first warning should state that there is an implicit declaration of "sprintf", because we have not included the C standart input and output library.
